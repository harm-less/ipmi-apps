...
(function() {
  ...
  var logos = [
    loader.load('textures/atak.png'),
    loader.load('textures/bagels.png'),
    loader.load('textures/wirelab.png'),
    loader.load('textures/italy.png'),
    loader.load('textures/grolsch.png'),
    loader.load('textures/gusto.png'),
    loader.load('textures/fat.png'),
    loader.load('textures/wilmink.png')
  ];
